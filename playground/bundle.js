(function () {
...
})()(
  {
    ...
    3: [
      function (require, module, exports) {
        ...
        var randomNode = function (_a) {
          var childDepth = _a.childDepth,
            parentDepth = _a.parentDepth,
            noSiblings = _a.noSiblings,
            noPartners = _a.noPartners;
          return __assign(
            __assign(
              __assign(
                __assign(
                  {
                    width: randomInt_1.randomInt(20, 80),
                    height: randomInt_1.randomInt(20, 80),
                    name: randomName_1.randomName(),
                  },
                  childDepth && {
                    children: exports.randomTargets({
        ...
        var randomSides = function () {
          return new Array(randomInt_1.randomInt(0, 2))
            .fill(0)
            .map(function () {
        ...
        var randomTargets = function (_a) {
          var childDepth = _a.childDepth,
            parentDepth = _a.parentDepth;
          return new Array(randomInt_1.randomInt(1, 4))
            .fill(0)
            .map(function () {
              return exports.randomNode({
      ...
      function (require, module, exports) {
        ...
        function drawPaths(subtree) {
          ...
          function getSameD(sourceNode, targetNode) {
            ...
            return `M${left.x + left.width} ${left.y + left.height / 2} L${
              right.x
      ...
      function (require, module, exports) {
        ...
        var addTargetNodesSize = function (nodes, settings) {
          nodes.forEach(function (node, index) {
            ...
            partners === null || partners === void 0
              ? void 0
              : partners.forEach(function (partner, partnerIndex) {
        ...
        var centerSourceToTargets = function (source, targets) {
          ...
          if (!source.isRoot) {
            ...
            if (leftMostTarget && rightMostTarget) {
              var newSourceX =
                (leftMostTarget.x + rightMostTarget.x + rightMostTarget.width) /
                  2 -
                source.width / 2;
              var delta_1 = newSourceX - source.x;
              if (newSourceX !== source.x) {
                source.x += delta_1;
                (_a = source.siblings) === null || _a === void 0
                  ? void 0
                  : _a.forEach(function (sibling) {
                      return (sibling.x += delta_1);
                    });
                (_b = source.partners) === null || _b === void 0
                  ? void 0
                  : _b.forEach(function (partner) {
                      return (partner.x += delta_1);
                    });
              }
            }
          }
    ...
    9: [
      function (require, module, exports) {
        ...
        var getInitialTargetsShiftLeft = function (source, targets, settings) {
          return (
            targets.reduce(function (totalWidth, target, index) {
    ...
    10: [
      function (require, module, exports) {
        ...
        function layout(root, customSettings) {
          ...
          var settings = __assign(
            __assign({}, exports.defaultSettings),
            customSettings
          );
          ...
          (_a = root[settings.siblingsAccessor]) === null || _a === void 0
            ? void 0
            : _a
                .reverse()
          ...
          (_b = root[settings.partnersAccessor]) === null || _b === void 0
            ? void 0
            : _b.forEach(function (partner, partnerIndex, rootPartners) {
                partner.source = root;
          ...
          function drillChildren(subtree) {
            ...
            var initialShiftLeft =
              getInitialTargetsShiftLeft_1.getInitialTargetsShiftLeft(
                subtree,
                children,
                settings
              );
            ...
            children.forEach(function (child) {
              ...
              /////////////////// SIBLING
              (_a = child[settings.siblingsAccessor]) === null || _a === void 0
                ? void 0
                : _a.forEach(function (sibling) {
              ...
              /////////////////// partners
              (_b = child[settings.partnersAccessor]) === null || _b === void 0
                ? void 0
                : _b.forEach(function (partner) {
          ...
          function drillParents(subtree) {
            ...
            parents.forEach(function (parent) {
              ...
              /////////////////// SIBLING
              (_a = parent[settings.siblingsAccessor]) === null || _a === void 0
                ? void 0
                : _a.forEach(function (sibling) {
                    sibling.isSibling = true;
              ...
              /////////////////// partners
              (_b = parent[settings.partnersAccessor]) === null || _b === void 0
                ? void 0
                : _b.forEach(function (partner) {
                    partner.isPartner = true;
        ...
        function getGenerationBottomLineY(subtree) {
          ...
          (_a = subtree.siblings) === null || _a === void 0
            ? void 0
            : _a.forEach(function (sibling) {
          ...
          (_b = subtree.partners) === null || _b === void 0
            ? void 0
            : _b.forEach(function (partner) {
                bottomLineY = Math.max(
                  bottomLineY,
      ...
      {
        "./addTargetNodesSize": 7,
        "./centerSourceToTargets": 8,
        "./getInitialTargetsShiftLeft": 9,
        "./normalizeTree": 12,
        "./shiftFromCountour": 13,
      },
    ],
    11: [
      function (require, module, exports) {
        ...
        var last = function (array) {
          return array === null || array === void 0
            ? void 0
    ...
    12: [
      function (require, module, exports) {
        ...
        var normalizeTree = function (root, accessor) {
          ...
          var leftMostNode = (
            (_a = targets[0].siblings) === null || _a === void 0
              ? void 0
              : _a[0]
          )
            ? (_b = targets[0].siblings) === null || _b === void 0
              ? void 0
              : _b[0]
            : targets[0];
          var lastTarget = last_1.last(targets);
          var lastTargetPartner = last_1.last(lastTarget.partners);
          var rightMostNode = lastTargetPartner
            ? lastTargetPartner
            : lastTarget;
          var centerPoint =
          ...
          function drillTargets(subtree) {
            ...
            (_a = subtree.siblings) === null || _a === void 0
              ? void 0
              : _a.forEach(function (sibling) {
                  return (sibling.x -= shift);
                });
            (_b = subtree.partners) === null || _b === void 0
              ? void 0
              : _b.forEach(function (partner) {
                  return (partner.x -= shift);
                });
            (_c = subtree[accessor]) === null || _c === void 0
              ? void 0
              : _c.forEach(function (node) {
                  drillTargets(node);
                });
          }
        };
