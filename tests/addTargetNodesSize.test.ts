...
test("adds sizes", () => {
  ...
  expect(targets[0].height).toBe(defaultSettings.defaultNodeHeight);
  expect(targets[0].marginBottom).toBe(defaultSettings.verticalSpacing);
  expect(targets[1].width).toBe(defaultSettings.defaultNodeWidth);
  expect(targets[1].height).toBe(1);
  expect(targets[1].marginBottom).toBe(defaultSettings.verticalSpacing);
  expect(targets[2].width).toBe(defaultSettings.defaultNodeWidth);
  expect(targets[2].height).toBe(defaultSettings.defaultNodeHeight);
